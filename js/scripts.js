(function ($) {
	...
	var announcementsLink = '<li class="announcements-menu-item"><a href="announcements-open-opportunities.html"><span>Announcements / Open Opportunities</span></a></li>';
	$(".navigation").each(function () {
		var $navigation = $(this);
		if (!$navigation.find('a[href="announcements-open-opportunities.html"]').length) {
			$navigation.find('> li').first().after(announcementsLink);
		}
	});
